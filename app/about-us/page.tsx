      ...
      <div className="container mx-auto px-10 lg:px-28 mt-16">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-16 lg:gap-24 mb-24">
          ...
          <div className="w-full lg:w-1/2 flex flex-col pt-4">
            ...
            <div className="space-y-6 text-tblack text-lg leading-relaxed">
              <p>
                TernakAja combines AI-powered analytics and IoT sensor
                technology to help farmers monitor livestock in real time,
                improve animal welfare, increase productivity, and operate more
                sustainably.
              </p>
              <p>
                Designed for cattle farmers in Indonesia, our solution uses non-
                invasive sensing technology with infrared temperature and PPG
                sensors to continuously monitor body temperature, heart rate,
                and blood oxygen levels. The collected data is analyzed using
                machine learning algorithms to enable early detection of
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          <div className="bg-background rounded-2xl p-8 flex flex-col items-center justify-center text-center shadow-md hover:shadow-xl transition-shadow border border-border/50 h-48 ">
            <h3 className="text-4xl font-extrabold text-tblack mb-3">100+</h3>
            <p className="text-lg font-medium text-tblack/80">Active Farms</p>
          </div>

          {/* Stat Card 2 */}
          <div className="bg-background rounded-2xl p-8 flex flex-col items-center justify-center text-center shadow-md hover:shadow-xl transition-shadow border border-border/50 h-48">
            <h3 className="text-4xl font-extrabold text-tblack mb-3">1000+</h3>
          ...
          {/* Stat Card 3 */}
          <div className="bg-background rounded-2xl p-8 flex flex-col items-center justify-center text-center shadow-md hover:shadow-xl transition-shadow border border-border/50 h-48">
            <h3 className="text-4xl font-extrabold text-tblack mb-3">80%</h3>
            <p className="text-lg font-medium text-tblack/80">
          ...
          {/* Stat Card 4 */}
          <div className="bg-background rounded-2xl p-8 flex flex-col items-center justify-center text-center shadow-md hover:shadow-xl transition-shadow border border-border/50 h-48">
            <h3 className="text-4xl font-extrabold text-tblack mb-3">90%</h3>
            <p className="text-lg font-medium text-tblack/80">
      ...
      <div className="flex flex-col gap-24 lg:gap-32 p-20 px-40 mt-20">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="text-tblack/90 text-lg lg:text-xl leading-relaxed font-medium">
              To revolutionize livestock management globally through innovative
              technology, creating a world where farming is efficient,
              sustainable, and humane, contributing to food security while
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 order-2 lg:order-1">
            ...
            <p className="text-tblack/90 text-lg lg:text-xl leading-relaxed font-medium">
              To empower farmers with AI and IoT solutions that optimize
              livestock health, productivity, and welfare while promoting
              sustainable agricultural practices aligned with global development
              goals.
            </p>
          </div>
