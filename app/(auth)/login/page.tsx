...
export default function LoginPage() {
  return (
    // Outer Container: Set bg-primary as the base color
    <div className="p-10 min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-primary">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <Image
          ...
          priority
        />
        {/* Optional: Slight gradient overlay if you want depth */}
      ...
      {/* ========================
          LOGIN CARD
      ======================== */}
      {/* Added 'relative z-10' to ensure it sits ON TOP of the background */}
      <div className="relative z-10 w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[600px]">
        ...
        <div className="w-full md:w-1/2 p-10 lg:p-16 flex flex-col justify-center bg-background">
          ...
          <form className="space-y-6">
            ...
            <button
              type="button"
              className="w-full py-3 px-4 bg-primary text-white font-bold rounded-lg hover:bg-primary/90 transition-opacity shadow-md"
            >
              Log In
            </button>
          </form>
