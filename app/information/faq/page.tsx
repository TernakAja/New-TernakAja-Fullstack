    ...
    return (
        <div className="min-h-screen bg-background text-foreground flex flex-col pt-24">
            ...
            <main className="flex-1 max-w-5xl mx-auto w-full px-6 py-12">
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">FAQ & Bantuan</h1>
                <p className="text-lg text-muted-foreground mb-12">Technical troubleshooting for the TernakAja platform.</p>
