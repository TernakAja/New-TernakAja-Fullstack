...
export const HomePage = () => {
    return (
        <div className="">
            <main className="min-h-screen w-full relative overflow-hidden bg-primary pt-20">
      ...
      ======================== */}
                ...
                <section className="w-full h-full bg-secondary py-20 lg:py-14 px-20 overflow-hidden">
